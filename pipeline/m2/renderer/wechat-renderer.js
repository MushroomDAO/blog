...
<section style="margin-top:32px;padding:16px 18px;background:${theme.bgGray};border-radius:8px;font-size:12px;line-height:1.7;color:#888;">
  ...
  <div style="margin-top:8px;padding:8px 10px;border-left:3px solid ${theme.primary};background:#fff;border-radius:4px;color:#666;">⚠️ 文中介绍的开源代码与模型，仅供学习交流与技术借鉴。它们大多仍处于早期阶段，有待进一步研究和验证，请勿直接用于工作或生产环境；如需采用，请先自行充分测试，并核实其许可证与安全性。</div>

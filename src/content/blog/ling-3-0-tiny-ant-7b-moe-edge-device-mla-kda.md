...
![3 个 KDA 层负责效率、1 个 MLA 层负责压缩，交替排列驱动整条注意力流水线](../../assets/images/ling-3-0-tiny-ant-7b-moe-edge-device-mla-kda-fig-02.png)
...
![7.9B 总参数是庞大的知识库，推理时只有约 16.5%（1.3B）真正被激活转动](../../assets/images/ling-3-0-tiny-ant-7b-moe-edge-device-mla-kda-fig-01.png)
...
![BF16 精度重、INT4 压缩狠，FP8 卡在精度与压缩之间的甜点位](../../assets/images/ling-3-0-tiny-ant-7b-moe-edge-device-mla-kda-fig-03.png)
...
![86-90 tokens/s 流畅输出、8K 上下文峰值仅 8.34GiB，数据全程锁在设备内不出笔记本](../../assets/images/ling-3-0-tiny-ant-7b-moe-edge-device-mla-kda-fig-04.png)

...
> **代码仓库**：[github.com/MushroomDAO/Doris](https://github.com/MushroomDAO/Doris)（早期阶段）
...
iDoris 是 **Mycelium Protocol** 旗下 [Aura AI](https://github.com/MushroomDAO) 子组织的研究项目。所有代码 Apache 2.0 开源。
...
- **代码贡献**：[github.com/MushroomDAO/Doris](https://github.com/MushroomDAO/Doris)（早期阶段，欢迎讨论 issue）
...
- **License**：非商业 / 中小商业免费（≤50 人小社区永久免费）
...
> **Code Repo**: [github.com/MushroomDAO/Doris](https://github.com/MushroomDAO/Doris) (early stage)
...
### 9.2 How to Join (Permissionless)

iDoris is a research project under [Aura AI](https://github.com/MushroomDAO), a sub-org of Mycelium Protocol. All code Apache 2.0.
...
- **Code**: [github.com/MushroomDAO/Doris](https://github.com/MushroomDAO/Doris) (early stage, issues welcome)
...
- **License**: Free for non-commercial / SMB (≤50 person communities permanent free)

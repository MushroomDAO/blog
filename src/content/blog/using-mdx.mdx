---
title: 'Using MDX'
titleEn: 'Using MDX in Astro'
description: 'Lorem ipsum dolor sit amet'
descriptionEn: 'How to use MDX (Markdown + JSX) in Astro — import components, use JSX expressions, and mix interactive elements with Markdown content.'
pubDate: 'Jun 01 2024'
category: 'Research'

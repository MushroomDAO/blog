...
- **正在开发的 Task**：T1.1.3 搜索入口页面（状态：PR_OPEN）
- **分支 / worktree**：`feat/T1.1.3-search-page` / `../blog-F1.1`
- **PR**：[#31](https://github.com/MushroomDAO/blog/pull/31)（等人工 review）

## 进行中 / 待回执的 PR
| Task | PR | 状态 | 备注 |
|:---|:---|:---|:---|
| T1.1.3 | [#31](https://github.com/MushroomDAO/blog/pull/31) | PENDING | 需人工 approve 后合并（`--allow-trunk`） |
...
## 下一个 READY
- T1.1.3 完成后 → T1.1.4 评测查询集 + Recall@5 基线记录
